...
# ╔═╡ 1ab7f940-1191-11f0-23f0-65223f4d2972
using PlutoUI

# ╔═╡ 038fc0e6-f0bd-4103-aa68-f6b89af59e9c
using CSV

# ╔═╡ 69478151-e3b7-483b-82a1-4cee9c2e49be
using DataFrames

# ╔═╡ 329c7517-11cb-48f8-9756-d5cbb3eb17da
using MLJ

# ╔═╡ 97236f4d-6def-4b92-9308-af7262f62cdb
using Statistics

# ╔═╡ fcc49ad2-ea0c-4852-87e8-b4de811673df
using StatsBase

# ╔═╡ d9c4c5d4-1396-49a1-9227-da6d3489274e
using CairoMakie

# ╔═╡ 0055b161-57c5-43f6-b117-f0a9e2db6ade
using AlgebraOfGraphics

# ╔═╡ 408de633-7fbf-4ec8-b603-639480e14998
using Random

# ╔═╡ 9e396278-dc29-461d-8ad2-88678fa7e534
using MLJLinearModels

# ╔═╡ d1db9b99-a9cc-416d-b801-e083eb05cd91
using MLUtils

# ╔═╡ 7a053bfc-8a50-48af-bdd4-9fcb7459b789
## Exploratory Data Analysis


# ╔═╡ 46655c7f-029c-4113-86df-30c8bc266947
global_food_wastage_df = DataFrame(CSV.File("C:/Users/paulu/Desktop/Julia/global_food_wastage_dataset.csv", header=1))

# ╔═╡ f274f8bc-e9a7-4eb8-8f87-9323eb08e82b
for col_name in names(global_food_wastage_df)
        println(col_name)
end

# ╔═╡ 08530b69-9109-487f-97ce-2f55cdee3e7e
size(global_food_wastage_df)

# ╔═╡ b0aeb520-8c0a-41de-8f64-e28696371b83
describe(global_food_wastage_df)

# ╔═╡ 2c87306c-e4e4-4710-bb19-2d0819f8a066
schema(global_food_wastage_df) |> DataFrames.DataFrame

# ╔═╡ 4afa6beb-dd4b-45ef-b34c-1793f0f94611
coerce!(global_food_wastage_df, :Year => Continuous)

# ╔═╡ c947e42a-9e8f-49b8-9021-7744681bc6e7
coerce!(global_food_wastage_df, Textual => Multiclass)

# ╔═╡ 133a251e-b88a-42aa-a1ef-d6c657fe49cf
schema(global_food_wastage_df) |> DataFrames.DataFrame

# ╔═╡ 05bc0969-7324-491a-be96-9d4939f3a532
### Filtering out Fruits & Vegetables from Food Category in our dataset for us to get the target vaviable

# ╔═╡ 06575efd-bfe2-4d86-a96a-078c0b7b81fb
...
# ╔═╡ d1e395c2-d5e7-470e-b61d-d786038f2895
X_fin = MLJ.transform(ohenc_mach, X)

# ╔═╡ 26ae1548-4b12-4ccd-b4d8-56f5d349f8f2
schema(X_fin) |> DataFrames.DataFrame

# ╔═╡ f0154663-e880-4349-b511-a24404a59c0c
X_smach = machine(Standardizer(), X_fin)

# ╔═╡ ebfc096d-87a1-4afe-a4b9-11fc238d2dda
fit!(X_smach)

# ╔═╡ 30c54da3-50c6-41bb-a9e9-c88a2fa0034a
X_norm = MLJ.transform(X_smach, X_fin)

# ╔═╡ 756f21b0-821f-4182-ad44-e195125af26d
Y_smach = machine(Standardizer(), X_fin)

# ╔═╡ 21287640-2419-43ef-b363-fb37d1d56ec5
fit!(Y_smach)

# ╔═╡ d0f6908e-e330-4a2e-9436-8793df917f0a
Y_norm = MLJ.transform(Y_smach, X_fin)

# ╔═╡ cf44b676-1e7b-4b0f-bcbb-bedccd83a206
train_set, test_set = partition(1:nrow(Y_norm), 0.85)

# ╔═╡ 2d7b5e41-9498-460a-b028-387a5d451e92
Y_train = Y_norm[train_set, :]

# ╔═╡ 50b50a34-cd9b-4983-b6ad-f20f51df48fb
Y_test = Y_norm[test_set, :]

# ╔═╡ 90c73b66-ffe3-430e-b6fc-413e857b9d88
##Linear Regression Model

# ╔═╡ 3e779216-876c-4c75-a0cc-b3c5df3913b4
Y_norm_vector = Y_norm[:, 1]

# ╔═╡ 5322a63a-60a4-4168-8b19-0045b90174f7
LReg = @load LinearRegressor pkg = "MLJLinearModels" verbosity=0

# ╔═╡ 5f21432f-da3e-43cc-ab47-14c15c9b1653
reg_model = LReg(solver = Analytical())

# ╔═╡ d0628e7e-ee02-459d-9df4-90795227972d
reg_mach = machine(reg_model, X_norm, Y_norm_vector)


# ╔═╡ a0245e26-7774-480a-950c-4839d4a8982e
MLJ.fit!(reg_mach, rows=train_set)

# ╔═╡ 236b3b7e-cbba-48be-9fb6-db7c95f90e6a
evaluate!(reg_mach, resampling=CV(nfolds=10, shuffle=true, rng=42), measures=[rms], repeats=3)

# ╔═╡ fe2d1f3f-b51e-4dac-b5cc-947cc8e88b79
y_pred = MLJ.predict(reg_mach, X_norm)
...
manifest_format = "2.0"
project_hash = "461aa575979f4f746db7e57f9ecbacd3db5a1ead"
